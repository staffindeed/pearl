use crate::v1::circuit::chip::blake3::program::DWORD_SIZE;
use crate::v1::{
...
/// Checks that `hash_jackpot` meets the difficulty requirement, using
/// `nbits_override` instead of the header's nbits when provided.
